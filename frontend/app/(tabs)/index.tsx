...
import { printDashboardReport } from '../../src/utils/pdfReports';
...
export default function DashboardScreen() {
  ...
  const {
    ...
    getActiveStats, advocateName, unreadNotificationCount, sendWhatsAppMessage, syncStatus,
    retrySyncAll,
  } = useApp();
  ...
  const handlePrint = async () => {
    setPrinting(true);
    await printDashboardReport({
      advocateName,
      todayHearings: getTodayHearings(),
      upcomingHearings: getUpcomingHearings(7),
