    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
          ...
          <View style={styles.card}>
            {/* Phone is always read-only — it is the login credential */}
            <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: Spacing.m, paddingVertical: 14, gap: Spacing.m }}>
              <Text style={{ width: 110, ...Typography.footnote, color: c.textSecondary }}>Phone</Text>
              <Text style={{ flex: 1, ...Typography.subhead, color: c.textPrimary }}>
